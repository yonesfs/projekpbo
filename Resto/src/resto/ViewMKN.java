...
public class ViewMKN extends JFrame{
    JLabel lNom = new JLabel(" Nomor Meja: ");
    JTextField tfNom = new JTextField();
    JLabel lNama = new JLabel(" Nama Makanan: ");
    ...
    JLabel lPedas = new JLabel(" Tingkat Kepedasan: ");
    String[] tingkatPedas =
        {"Tidak Pedas", "Pedas", "Sangat Pedas"};
    ...
    Object namaKolom[] = {"ID","NomorMeja", "Nama Makanan", "Makan Di ?", "Harga Kejujuran", "Pembayaran Via", "Tingkat Kepedasan"};
